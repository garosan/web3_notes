...
- An Interface is Solidity file written by a developer to help other developers interact with his contract without having to know all the code and implementations of said contract.
